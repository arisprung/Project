...
public class ActionBarView extends AbsActionBarView
{
	 ...
	 */
	private static final int DISPLAY_RELAYOUT_MASK = ActionBar.DISPLAY_SHOW_HOME | ActionBar.DISPLAY_USE_LOGO | ActionBar.DISPLAY_HOME_AS_UP
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		if (mProgressView != null)
		{
			...
			mProgressView
					.layout(mProgressBarPadding, -halfProgressHeight, mProgressBarPadding + mProgressView.getMeasuredWidth(), halfProgressHeight);
		}
	}
