...
public class TailGateMessageContentProvider extends ContentProvider
{
	...
	static
	{
		sURIMatcher.addURI(AUTHORITY, BASE_PATH, MESSAGE);
		sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", MESSAGE_ID);
	}

	private MessageSQLiteHelper database;
	...
	public int delete(Uri uri, String selection, String[] selectionArgs)
	{
		...
		{
			case MESSAGE:
				rowsDeleted = sqlDB.delete(MessageSQLiteHelper.TABLE_MESSAGE, selection, selectionArgs);
				break;
			case MESSAGE_ID:
				String id = uri.getLastPathSegment();

				rowsDeleted = sqlDB.delete(MessageSQLiteHelper.TABLE_MESSAGE, MessageSQLiteHelper.COLUMN_ID + "=" + id, null);
	...
	public Uri insert(Uri uri, ContentValues values)
	{
		...
		{
			case MESSAGE:
				id = sqlDB.insert(MessageSQLiteHelper.TABLE_MESSAGE, null, values);
				break;
			default:
				throw new IllegalArgumentException("Unknown URI: " + uri);
		}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
	{
		...
		// Set the table
		queryBuilder.setTables(MessageSQLiteHelper.TABLE_MESSAGE);
